...
//    //Receive and store the input for jumping
...
//    //Receive and store the input for target locking
//    public void OnTargetLockInput(InputAction.CallbackContext context)
//    {
//        targetLockInput = context.ReadValue<float>();
